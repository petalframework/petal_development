defmodule AppWeb.PublicLive.TermsPage do
  ...
  def render(assigns) do
    ~F"""
    <Nav id="navbar" active_page={:terms} current_user={@current_user} />

    <section class="container px-4 py-24 mx-auto">
      <div class="mb-24 text-left md:text-center">
        <h1 class="mb-4 text-4xl font-bold leading-tight text-gray-900 md:text-5xl">Terms of use</h1>
